...
sed -i "8ipki_dir: $install_path/etc/salt/pki/master" $install_path/etc/salt/master
...
sed -i "7ipki_dir: $install_path/etc/salt/pki/minion" $install_path/etc/salt/minion
